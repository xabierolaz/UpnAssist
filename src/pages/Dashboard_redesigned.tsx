...
const Dashboard: React.FC = () => {
  ...
  const getClassesForDate = (date: Date): ClassInfo[] => {
    // Lunes = 1, Martes = 2, etc. (Domingo = 0 -> 7)
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Dashboard Académico UPN</h1>
            <p className="text-gray-600 mt-1">Gestión y seguimiento académico</p>
          </div>
          <div className="flex space-x-3">
            ...
            <button
              onClick={() => calendarStatus.calendarUrl && handleDownloadICS(calendarStatus.calendarUrl)}
              disabled={!calendarStatus.calendarUrl}
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="space-y-3">
              <p className="text-blue-800">
                Tu calendario académico está listo. Puedes copiarlo o descargarlo:
              </p>
      ...
      {/* Aplicaciones en fila horizontal */}
      <div className="bg-white rounded-lg shadow-sm p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          ...
          >
            ...
            <span className="text-sm font-medium text-blue-800">Herramientas</span>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        {/* Menu lateral fusionado (Herramientas + Accesos rápidos) */}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-orange-50 p-3 rounded-lg text-center">
                  ...
                  <div className="text-xs text-orange-700">Total Estudiantes</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Calendario Central - Más compacto y apaisado */}
        <div className="xl:col-span-2">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            {/* Grid del calendario optimizado para apaisado */}
            <div className="grid grid-cols-7 gap-2 mb-4">
              {(() => {
                const dayNames = ['Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom'];
                return dayNames.map(day => (
                  <div key={day} className="p-2 text-center text-sm font-semibold text-gray-500 bg-gray-50 rounded-lg">
                    {day}
                  </div>
                ));
              })()}
      ...
      {/* Modales */}
      {/* Modal de Aplicaciones y Herramientas */}
      {showAppsModal && (
