        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
              ...
              {/* Calendario principal - Más ancho */}
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 h-full">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      ...
                      {/* Botones de calendario junto al título */}
                  ...
                  <div className="grid grid-cols-7 gap-2 mb-4">
                    {(() => {
                      ...
                      return dayNames.map(day => (
                        <div key={day} className="p-3 text-center text-sm font-semibold text-gray-500 bg-gray-50 rounded-lg">
                          {day}
                        </div>
                      ));
                    })()}
                  ...
                  <div className="grid grid-cols-7 gap-2">
                    {(() => {
                      ...
                      for (let i = 0; i < startingDayOfWeek; i++) {
                        allDays.push(
                          <div key={`empty-${i}`} className="p-3 h-16"></div>
                        );
                      }
                      ...
                      for (let day = 1; day <= daysInMonth; day++) {
                        ...
                        allDays.push(
                          <div
                            key={day}
                            className={`p-3 h-16 cursor-pointer rounded-lg text-center transition-all hover:scale-105 relative ${
                              isSelected 
              ...
              {/* Panel lateral derecho - Agenda del día */}
              <div className="lg:col-span-1">
                <div className="bg-white rounded-lg shadow-sm p-6 h-full">
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200">
                    <h4 className="text-md font-semibold text-gray-900 mb-4">Próximas Clases</h4>
                    <div className="space-y-2">
                      {weeklySchedule.slice(0, 3).map((classInfo) => {
                        const dayNames = ['', 'Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom'];
                        return (
                          <div key={classInfo.id} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                            <div className="flex items-center">
                              <div className={`w-2 h-2 rounded-full mr-2 ${getSubjectColor(classInfo.subject)}`}></div>
                              <div>
